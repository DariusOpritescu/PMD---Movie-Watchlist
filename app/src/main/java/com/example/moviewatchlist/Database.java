...
public class Database extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_CATEGORY = "movie_category";
   ...
   Database(@Nullable Context context) {
    ...
    void addBook(String title, String director, String category){
    ...
    void updateData(String row_id,String name, String director, String category){
       SQLiteDatabase db = this.getWritableDatabase();
       ContentValues cv = new ContentValues();
